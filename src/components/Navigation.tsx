...
export default function Navigation() {
  ...
  // resolvedTheme is reliable after hydration; falls back gracefully
  ...
  const isDark = mounted ? resolvedTheme === 'dark' : true; // default dark avoids flash
  ...
  return (
    <>
      {/* 
        Fixed bar: must anchor left+right so it spans the viewport,
        then constrain inner content with maxWidth + auto margins.
        Using left/right instead of letting margin alone handle it.
      */}
      <nav
        style={{
          position: 'fixed',
        ...
        >
          ...
          <div style={{
            ...
            <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0, textDecoration: 'none' }}>
              <svg viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '32px', height: '32px', flexShrink: 0 }}>
              ...
              {/* Brand name — visible on md+ so the bar has identity on tablet */}
              <span style={{
                ...
                display: 'none', // hidden on mobile; shown via className below
              }} className="sm:block">
                SOBRAL
              </span>
            </Link>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '2px', flex: '1 1 0', justifyContent: 'center', minWidth: 0 }} className="hidden lg:flex">
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      letterSpacing: '1.6px',
                      textTransform: 'uppercase',
                      color: active ? `${primary}dd` : isDark ? '#8fa5bf' : '#5a6b7f',
                      background: active ? `${primary}1f` : 'transparent',
                      border: `1px solid ${active ? `${primary}73` : 'transparent'}`,
                      borderRadius: '2px',
                  ...
                  >
                    ...
                    {/* Hover underlay — only when not active */}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexShrink: 0 }}>
              ...
              <a
                ...
                style={{
                  ...
                  border: `1px solid ${primary}40`,
                  background: isDark ? 'rgba(4,8,16,0.6)' : 'rgba(255,255,255,0.6)',
                  borderRadius: '2px',
              ...
              >
                {mobileMenuOpen
                  ? <X     style={{ width: '18px', height: '18px', color: isDark ? '#8fa5bf' : '#5a6b7f' }} />
                  : <Menu  style={{ width: '18px', height: '18px', color: isDark ? '#8fa5bf' : '#5a6b7f' }} />
                }
              </button>
            </div>
          </div>

          {/* ── Mobile menu — wrapped in AnimatePresence for proper exit animation ── */}
            ...
            {mobileMenuOpen && (
              ...
              >
                <div style={{ padding: '8px 0' }}>
                    ...
                    return (
                      <Link
                        ...
                        style={{
                          ...
                          background: active ? `${primary}1a` : 'transparent',
                          transition: 'all .15s',
                          textDecoration: 'none',
                        }}
                      >
                  ...
                  {/* Mobile-only bottom row: GitHub + LanguageSwitcher */}
                  <div
                    className="md:hidden"
                    style={{
                      display: 'flex',
