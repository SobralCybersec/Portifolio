...
export default function BongoCat() {
  return (
    ...
    >
      <div className="bongo-cat-frame">
        <div className="bongo-cat-topline" aria-hidden="true">
          <span className="bongo-cat-dots">
            <i />
            <i />
            <i />
          </span>
        ...
        <svg id="bongo-cat" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 787.3 433.8">
          ...
          <g id="head">
            ...
            <g id="head__face">
              <g id="eyes">
                <use width="19.2" height="18.7" transform="translate(474.8 195.2)" href="#eye" />
                <use width="19.2" height="18.7" transform="matrix(-0.51, -0.85, 0.82, -0.5, 370.39, 192.59)" href="#eye" />
              </g>
              <g id="mouth">
          ...
          <g id="table">
            <path d="M65.7,181.8l714,124c0,74-2,54-2,128l-673-161Z" fill="#fff" />
            <path d="M786.7,304.2c-2.7,1.2-10.8,0-16.1-.9L31.1,176.4c-5.2-.9-8.9-3.8-6.2-5s14.3-1.4,19.5-.5L777.1,300.6C782.3,301.6,789.4,303.1,786.7,304.2Z" />
          </g>
          <g id="laptop">
            <g id="laptop__base">
              <polygon points="641.9 304.1 454.7 348.2 103.8 271.3 254.6 230.3 641.9 304.1" fill="#f2f2f2" />
              <path d="M641.9,304.1c1.5-.1-2.3,1.5-10.3,3.6-28.9,7.5-58.1,15.2-87.7,22.6s-59.1,14.5-88.4,21.3l-.8.2-.8-.2-349.5-78-1.1-.2-8.7-1.9,8.6-2.3,150.6-41.5.6-.2h.7c62.5,11.7,125.5,23.6,188.4,35.9s125.6,25.1,188,37.6c8,1.6,11.9,3,10.4,3a185.6,185.6,0,0,1-18.4-2.6c-61.9-11.2-123.6-22.2-185-33.5s-122.7-23.1-184.4-35h1.2L104.4,273.4h-.1v-4.3l351.2,75.7h-1.5c28.3-6.7,56.3-13.3,84.3-19.5s56.5-12,85.2-18.1C631.3,305.6,640.4,304.1,641.9,304.1Z" fill="#231f20" />
            </g>
            <g id="laptop__keyboard">
              <polygon points="371.1 274.8 256.8 253.5 257 252.7 266.2 251.1 382.4 271.5 382.3 272.3 371.1 274.8" fill="#3e3e54" />
              <polygon points="237.4 265.6 221.3 262.4 221.4 261.7 230.2 260.2 246.8 262.6 246.6 263.4 237.4 265.6" fill="#3e3e54" />
              <polygon points="474.6 312.9 249.9 268.1 250.1 267.3 259.2 265.8 487.7 309.6 487.5 310.5 474.6 312.9" fill="#3e3e54" />
              <polygon points="411.8 309.4 204.2 266.7 204.4 266 212.9 264.5 423.9 306.3 423.7 307.2 411.8 309.4" fill="#3e3e54" />
              <polygon points="450 317.3 428.5 312.9 428.8 312 440.7 310.6 462.7 314.1 462.5 315 450 317.3" fill="#3e3e54" />
              <polygon points="201.6 273.9 187.5 270.9 187.7 270.2 196 268.7 210.4 271 210.3 271.7 201.6 273.9" fill="#3e3e54" />
              <polygon points="222.6 278.3 208.1 275.3 208.3 274.5 216.9 273.1 231.8 275.4 231.6 276.2 222.6 278.3" fill="#3e3e54" />
              <polygon points="362.9 308.1 231.5 280.2 231.7 279.5 240.7 278.1 374.2 305.1 374 305.9 362.9 308.1" fill="#3e3e54" />
              <polygon points="444.3 288.4 385.2 277.4 385.4 276.5 396.6 274.9 456.9 285.1 456.7 285.9 444.3 288.4" fill="#3e3e54" />
              <polygon points="526.1 303.6 460.1 291.3 460.3 290.4 472.8 288.9 540.1 300.2 539.9 301.1 526.1 303.6" fill="#3e3e54" />
              <polygon points="426.2 321.6 376.1 310.9 376.3 310.1 387.4 308.7 438.5 318.5 438.3 319.4 426.2 321.6" fill="#3e3e54" />
              <g>
                <polygon points="410.6 286.5 399.1 288 398.9 288.8 499.9 308.3 513.3 305.9 513.5 305 410.6 286.5" fill="#3e3e54" />
                <polygon points="395.7 283.7 395.9 282.8 248.2 255.7 239.2 257.3 239 258 384.3 286 395.7 283.7" fill="#3e3e54" />
              </g>
              <polygon points="371.3 273.9 256.9 252.7 266.4 250.3 382.4 271.5 371.3 273.9" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="237.6 264.9 221.4 261.7 230.4 259.4 246.8 262.6 237.6 264.9" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="474.8 312 250 267.3 259.4 265.1 487.7 309.6 474.8 312" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="412 308.5 204.4 266 213.1 263.8 423.9 306.3 412 308.5" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="450.2 316.4 428.8 312 440.9 309.7 462.8 314.1 450.2 316.4" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="201.7 273.1 187.7 270.2 196.2 268 210.4 271 201.7 273.1" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="222.8 277.6 208.3 274.5 217.1 272.4 231.8 275.4 222.8 277.6" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="363.1 307.3 231.7 279.5 240.9 277.3 374.2 305.1 363.1 307.3" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="444.6 287.5 385.4 276.5 396.8 274.1 456.9 285 444.6 287.5" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="526.3 302.7 460.3 290.4 473 288 540.1 300.2 526.3 302.7" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <polygon points="426.4 320.7 376.3 310.1 387.6 307.9 438.5 318.5 426.4 320.7" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              <g>
                <polygon points="410.7 285.6 399.1 288 500.1 307.4 513.5 305 410.7 285.6" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
                <polygon points="395.9 282.8 248.4 255 239.2 257.3 384.5 285.2 395.9 282.8" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              </g>
            </g>
            <g id="paw-right">
              <g id="paw-right--down">
                <path d="M293.2,191.3l10-7s-18.4,11.1-24,20-13,20.4-9,31c4.7,12.4,20.5,15.7,22,16,20,3.8,47.8-24.3,47.8-24.3s1.9-3.3,2.2-3.7" fill="#fff" />
              ...
              <g id="paw-right--up">
                <g>
                  <path d="M282.2,215.2c-1.6-1.6-12.8-17.9-14-34.3-.1-2.5,1.7-16,12.9-22.4s22.3-1.9,26.2.4c12.2,7.3,21.2,19.1,22.8,22.4" fill="#fff" />
                ...
                <use width="31.4" height="33.93" transform="translate(273.2 166.1) rotate(-5.6)" href="#paw-pads" />
              </g>
            </g>
            <g id="laptop__terminal">
              <path d="M316.9,238.7,153.5,205.2a5.1,5.1,0,0,1-4-3.5L109.8,75.4c-1-3.3,1.9-6.6,5.6-6.3L277.9,84.5a5.2,5.2,0,0,1,4.6,3.7l40.7,144.4C324.2,236.2,320.8,239.5,316.9,238.7Z" />
              ...
              <g id="laptop__code">
                <g stroke="#3DE0E8" strokeWidth="6" transform="matrix(-1 0 0 1 278 103)">
                  <g id="f3" transform="translate(0 76)">
                    <path id="f3-l9" className="typing-animation" d="M8,25L96,25" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                    <path id="f3-l8" className="typing-animation" d="M8,13L146,13" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                    <path id="f3-l7" className="typing-animation" d="M0,1L96,1" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                  </g>
                  <g id="f2" transform="translate(0 38)">
                    <path id="f2-l6" className="typing-animation" d="M8,25L69,25" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                    <path id="f2-l5" className="typing-animation" d="M8,13L114,13" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                    <path id="f2-l4" className="typing-animation" d="M0,1L136,1" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                  </g>
                  <g id="f1">
                    <path id="f1-l3" className="typing-animation" d="M8,25L61,25" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                    <path id="f1-l2" className="typing-animation" d="M8,13L124,13" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                    <path id="f1-l1" className="typing-animation" d="M0,1L160,1" pathLength="1" strokeDasharray="1" strokeDashoffset="1" />
                  </g>
                </g>
              </g>
            </g>
          ...
          <g id="paw-left">
            <g id="paw-left--up">
              <g>
                <path d="M545.4,261.9c-7.1-13-12.9-31.1-13.3-37.6-.6-9,0-15.6,5.2-22.2s15-9.8,22.7-8.8a26.7,26.7,0,0,1,17.3,9.4c5.3,5.8,9.4,12.9,11.6,16.6" fill="#fff" />
              ...
              <use width="31.4" height="33.93" transform="matrix(0.99, -0.03, 0.04, 1, 539.85, 203.52)" href="#paw-pads" />
            </g>
            <g id="paw-left--down">
              <path d="M538.2,239.3c-3.2,1.6-33,10.8-37,28-.4,1.8-2.1,18.9,7,26,5.5,4.3,12.7,2.8,25,0,10.3-2.3,19-5.8,40-16,9.1-4.4,16.6-8.2,22-11" fill="#fff" />
      ...
      <style jsx>{`
        ...
        /* Re-theme the original illustration without changing its geometry. */
        #bongo-cat [fill='#fff'],
